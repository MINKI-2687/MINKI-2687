...
- 🎓 On-Device AI 반도체 설계 과정 수료 (KCCISTC)
- 🔩 Verilog / SystemVerilog 기반 RTL 설계 및 FPGA 검증
- 🖥️ RISC-V RV32I Multi-Cycle CPU 설계 (Instruction Fetch → Write-Back 전 과정)
- 📡 UART, SPI, I2C, AXI4-Lite, APB 등 통신 프로토콜 설계 경험
- 🎥 OV7670 카메라 SCCB 제어 및 VGA 영상 출력 파이프라인 구현
- 🛠️ Xilinx Vivado / MicroBlaze SoC 통합 설계 경험
